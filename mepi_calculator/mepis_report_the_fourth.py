...
from entropy_calculator_2 import get_entropy_2 as get_entropy
from reducciones_de_entropia_single_tensor_gray_v_powell import *
from funcion_de_busqueda_the_second import entropy_of_a_tensor, entropy_of_a_tensor_crop, entropy_of_a_tensor_downsampling, entropy_of_a_tensor_quantization
...
def get_mepis_report(report_folder, report_name, neural_network, test_loader, funcion_objetivo=entropy_of_a_tensor, punto_inicial=(0.075, 0.075, 0.075, 0.075, 0.9, 0.6), names_pics={}, max_iteration_number=3):
  ...
  for i, data in enumerate(test_loader):
    ...
    ##FOLDER_TO_SAVE = f'{report_folder}/{names_pics[i]}'
    ##plt.savefig(FOLDER_TO_SAVE)
    # Almacenar entropía
