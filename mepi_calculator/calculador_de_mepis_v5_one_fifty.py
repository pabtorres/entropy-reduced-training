...
from entropy_calculator import get_entropy
from entropy_reductions_v3 import *
from funcion_de_busqueda_powell import entropy_of_a_tensor, entropy_of_a_tensor_crop, entropy_of_a_tensor_downsampling, entropy_of_a_tensor_quantization
from scipy import optimize
import time
from dataset_classes import ValidationDataset
from torch.utils.data import Dataset, DataLoader
from torchvision import datasets, transforms as T
import matplotlib.pyplot as plt
import csv
import json
from mepis_report_the_fourth import get_mepis_report

# Import system
import sys

# Redes neuronales
from networks_controller_v11 import instantiate_network
...
def run_it(RED_USADA, METODOLOGIA, ADAPTIVEORFIXED, DIMENSION):
    ...
    #ADAPTIVEORFIXED = input("Ingrese si es adaptive o fixed\n")
    #ESQUEMA = '16c1r'
    DIRECTORIO = f'{NOMBRE_CARPETA}/{RED_USADA}/{METODOLOGIA}/{ADAPTIVEORFIXED}/{DIMENSION}'

    # Cargar punto de control
    #CHECKPOINT = input("Ingrese directorio punto de control\n")
    #CHECKPOINT = f'ExperimentosAlpha/resnet18/Combined/16c1r/Checkpoints/ImageNet-resnet18-50_CHECKPOINT_16c1r_CLASSIC'
    #CHECKPOINT = f'ExperimentosPairRoundsGrayTheSecond/effnetb3/Combined/DeltaAlfa_0125/Checkpoints/ImageNet-effnetb3-46_CHECKPOINT_CLASSIC'
