...
from thesis_quality_reduction_parameters_generator import produce_reductions_json
...
def run_it(dimension, delta_alfa, red, input_folder):
  ...
  FOLDER_EXPERIMENT = f'Results_PairedRounds_Adaptive/{input_folder}/{NEURAL_NETWORK_NAME}/{DIMENSION}/{D_ALFA}'
