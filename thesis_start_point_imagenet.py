...
def run_it(dimension, valor_de_alfa, red):
  # FILE SYSTEM
  ...
  FOLDER_EXPERIMENT = f'BaselinesTrickyV2/{NEURAL_NETWORK_NAME}/{DIMENSION}/{EXPERIMENT_MIX}'
  ...
  train_loader = DataLoader(TrainingDataset(transform=transform, list='humanet_training_set_v2.json'), batch_size=BATCH_SIZE,
                            shuffle=True, num_workers=8)
  test_loader = DataLoader(ValidationDataset(transform=transform, list='humanet_minival_set_v2.json'), batch_size=BATCH_SIZE,
