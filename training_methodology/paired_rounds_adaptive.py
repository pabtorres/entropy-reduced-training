...
def run_it(dimension, delta_alfa, red, input_folder):
  ...
  input_folder = f'F_PairedRounds_Adaptive_{input_folder}'

  NEURAL_NETWORK_NAME = red # [STAR] Tiene una ocurrencia abajo, en caso de cambiarla, cambiar ambas
  FOLDER_EXPERIMENT = f'New_PairedRounds_Adaptive/{input_folder}/{NEURAL_NETWORK_NAME}/{DIMENSION}/{D_ALFA}'
  ...
  for i in range(CICLOS):
    ...
    if acc_val_anterior == acc_val_actual:
      ...
      # No es necesario seguir entrenando
      print(f'No es necesario seguir entrenando')
