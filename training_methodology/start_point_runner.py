...
from herrramientas_de_entrenamiento_i9 import train_for_classification
...
def run_it(dimension, valor_de_alfa, red, input_folder):
  ...
  FOLDER_EXPERIMENT = f'New_Baselines/{input_folder}/{NEURAL_NETWORK_NAME}/{DIMENSION}/{EXPERIMENT_MIX}'
