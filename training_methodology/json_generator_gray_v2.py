...
from generador_de_transformaciones_location_crop import *
...
from persist_results import persist_list

from round_utils_gray import apply_transformation_from_list
...
def produce_reductions_json(net, train_loader, delta_alpha, red_dim = 'Combined', device='cuda'):
  ...
  for e in range(1):  
    ...
    for i, data in enumerate(train_loader):
      ...
      #a = input("esperando")
    # aquí se debería appendear en el json...
